...
get_header(); ?>
    <div class="mainWrap mainWrap-medium">
        <section class="l-articles row">
            ...
            <div class="column small-12">
                <?php echo do_shortcode('[ajax_load_more post_type="video-collections" posts_per_page="10" offset="10" pause="true" scroll="false" button_label="' . get_field('load_more_posts') . '" button_loading_label="' . __('Загрузка', 'science-of-everything') . '"]'); ?>
            </div>
        </section>
    </div>
    <style>
