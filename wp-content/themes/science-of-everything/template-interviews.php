    ...
    <section class="l-articles row">
                    ...
                    if ($i == 0) { ?>
                        <li class="articlesList-item-hover columns column-block large-8 small-12 articlesList-medium">
                            <a class="articlesList-item-banner twoThirds" href="<?php the_permalink(); ?>">
                                <div class="articlesList-item-bg"><img src="<?php the_field('main-image'); ?>">
                                </div>
        ...
        <div class="column small-12">
            <?php if($_GET['sort'] == 'popular') {
                echo do_shortcode('[ajax_load_more post_type="interview" meta_key="views" orderby="meta_value_num" order="DESC" posts_per_page="6" offset="7" pause="true" scroll="false" button_label="' . get_field('load_more_posts') . '" button_loading_label="' . __('Загрузка', 'science-of-everything') . '"]');
            } else {
                echo do_shortcode('[ajax_load_more post_type="interview" posts_per_page="6" offset="7" pause="true" scroll="false" button_label="' . get_field('load_more_posts') . '" button_loading_label="' . __('Загрузка', 'science-of-everything') . '"]');
            }?>
        </div>
    </section>
</div>
